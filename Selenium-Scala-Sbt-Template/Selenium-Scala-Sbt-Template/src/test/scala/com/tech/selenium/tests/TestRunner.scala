...
import com.tech.selenium.pageobjects.{GoogleSearchPage, SearchResultsPage}
import org.openqa.selenium.WebDriver
import org.scalatest._
import org.scalatest.selenium.WebBrowser

class TestRunner extends FeatureSpec with GivenWhenThen with Matchers with WebBrowser with BeforeAndAfterAll with BeforeAndAfterEach  {
